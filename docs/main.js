...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (function () {\n  var _marked =\n  /*#__PURE__*/\n  regeneratorRuntime.mark(secondsGen),\n      _marked2 =\n  /*#__PURE__*/\n  regeneratorRuntime.mark(minutesGen),\n      _marked3 =\n  /*#__PURE__*/\n  regeneratorRuntime.mark(hoursGen);\n\n  var div = document.querySelector(\".tiktak\");\n  var currentTime = new Date();\n  var seconds = currentTime.getSeconds();\n  var minutes = currentTime.getMinutes();\n  var hours = currentTime.getHours();\n  hours = hours > 12 ? hours - 12 : hours;\n\n  function secondsGen() {\n    return regeneratorRuntime.wrap(function secondsGen$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            if (false) {}\n\n            _context.next = 3;\n            return seconds++;\n\n          case 3:\n            _context.next = 0;\n            break;\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _marked);\n  }\n\n  var secGen = secondsGen();\n\n  function minutesGen() {\n    return regeneratorRuntime.wrap(function minutesGen$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            if (false) {}\n\n            _context2.next = 3;\n            return minutes++;\n\n          case 3:\n            _context2.next = 0;\n            break;\n\n          case 5:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _marked2);\n  }\n\n  var minGen = minutesGen();\n\n  function hoursGen() {\n    return regeneratorRuntime.wrap(function hoursGen$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            if (false) {}\n\n            _context3.next = 3;\n            return hours++;\n\n          case 3:\n            _context3.next = 0;\n            break;\n\n          case 5:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _marked3);\n  }\n\n  var hGen = hoursGen();\n  setInterval(function () {\n    secGen.next().value;\n\n    if (seconds === 60) {\n      minGen.next().value;\n      seconds = 0;\n    }\n\n    if (minutes === 60) {\n      hGen.next().value;\n      minutes = 0;\n    }\n\n    if (hours === 12) {\n      hours = 0;\n    }\n\n    div.innerHTML = \"\".concat(hours.toString().padStart(2, \"0\"), \":\").concat(minutes.toString().padStart(2, \"0\"), \":\").concat(seconds.toString().padStart(2, \"0\"));\n  }, 1000);\n});\n\n//# sourceURL=webpack:///./src/script.js?");
